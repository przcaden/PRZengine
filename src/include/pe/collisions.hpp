...
namespace pe {
	...
	private:
		float radius;
	public:
		Circle(float rad, float res, float x, float y) {
	...
	inline bool circleIntercept(Circle a, Circle b) {
	...
	inline void rebound(Object a, Object b) {
	...
	inline bool circlevcircle(Manifold* m) {
